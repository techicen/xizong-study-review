...
* Updated README scenario tables and examples so typical learning workflows are presented as Codex + WorkBuddy compatible, not WorkBuddy-only or Codex-first.
